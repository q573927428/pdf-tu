...
body{font-family:Arial,\"Microsoft YaHei\",sans-serif;margin:20px;color:#222}h1{font-size:22px}.filter-bar{display:flex;align-items:center;gap:14px;margin:0 0 14px}.filter-bar #search{box-sizing:border-box;width:min(520px,100%);padding:9px 12px;border:1px solid #bbb;border-radius:6px;font-size:14px}.category-filter{padding:8px 10px;border:1px solid #bbb;border-radius:6px;background:#fff;color:#222;font-size:14px}.published-toggle{display:inline-flex;align-items:center;gap:7px;white-space:nowrap;cursor:pointer}.published-toggle input{width:16px;height:16px;margin:0;accent-color:#1769aa;cursor:pointer}
